...
export async function getSpotifyArtists(spotifyToken: string, artistNames: string[]): Promise<SpotifyArtist[]> {
...
export function getTracksForArtist(spotifyToken: string, spotifyArtist: SpotifyArtist): Promise<SpotifyTrack[]> {
    const getOptions = helpers.baseSpotifyHeaders("GET", spotifyToken);
...
export async function getAllTracksToAdd(spotifyToken: string, spotifyArtists: SpotifyArtist[]): Promise<SpotifyTrack[]> {
    const getOptions = helpers.baseSpotifyHeaders("GET", spotifyToken);
...
export async function getOrCreatePlaylist(spotifyToken: string, userObj: User): Promise<SpotifyPlaylist> {
    const getOptions = helpers.baseSpotifyHeaders("GET", spotifyToken);
...
export async function addTracksToPlaylist(spotifyToken: string, playlistObj: SpotifyPlaylist, trackUris: string[]): Promise<void> {
